...
// Type: App.Infrastructure.CoreHelper
...
namespace App.Infrastructure
{
    public class CoreHelper : ICoreHelper
    {
        ...
        public CoreHelper(ScriptatDBContext _context) => this.context = _context;

        public async Task<string> GetProjectCode(int _projectId)
        {
            string _result = string.Empty;
            Project async = await this.context.Project.FindAsync((object)_projectId);
            if (async != null)
                _result = async.ProjectCode;
            string projectCode = _result;
            _result = (string)null;
            return projectCode;
        }
